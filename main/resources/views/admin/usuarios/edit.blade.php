...
@section('content')
  <form action="{{ route('admin.usuarios.update', $usuario) }}" method="POST" class="space-y-4">
    ...
    <div>
      ...
      <input name="password_confirmation" type="password" class="w-full border rounded px-2 py-1">
    </div>
    ...
    <a href="{{ route('admin.usuarios.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded">Voltar</a>
  </form>
@endsection
